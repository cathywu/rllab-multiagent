...
echo "Conda environment created! Make sure to run \`source activate rllab-multiagent\` whenever you open a new terminal and want to run programs under rllab."
